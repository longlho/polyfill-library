(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var likelySubtags = tslib_1.__importStar(require$$0);
    ...
    function canonicalizeUnicodeLanguageId(unicodeLanguageId) {
        ...
        if (finalLangAst.region) {
            ...
            if (regionAlias) {
                ...
                var likelySubtag = likelySubtags.supplemental.likelySubtags[emitter.emitUnicodeLanguageId({
                    lang: finalLangAst.lang,
                    script: finalLangAst.script,
                    variants: [],
                })];
    ...
    var intlGetcanonicallocales = createCommonjsModule(function (module, exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    tslib_1.__exportStar(emitter, exports);
    });
    ...
    var likelySubtags = supplemental.likelySubtags;
    var RELEVANT_EXTENSION_KEYS = ['ca', 'co', 'hc', 'kf', 'kn', 'nu'];
    var UNICODE_TYPE_REGEX = /^[a-z0-9]{3,8}(-[a-z0-9]{3,8})*$/i;
    function applyOptionsToTag(tag, options) {
        invariant(typeof tag === 'string', 'language tag must be a string');
        invariant(intlGetcanonicallocales.isStructurallyValidLanguageTag(tag), 'malformed language tag', RangeError);
        var language = GetOption(options, 'language', 'string', undefined, undefined);
        if (language !== undefined) {
            invariant(intlGetcanonicallocales.isUnicodeLanguageSubtag(language), 'Malformed unicode_language_subtag', RangeError);
        }
        var script = GetOption(options, 'script', 'string', undefined, undefined);
        if (script !== undefined) {
            invariant(intlGetcanonicallocales.isUnicodeScriptSubtag(script), 'Malformed unicode_script_subtag', RangeError);
        }
        var region = GetOption(options, 'region', 'string', undefined, undefined);
        if (region !== undefined) {
            invariant(intlGetcanonicallocales.isUnicodeRegionSubtag(region), 'Malformed unicode_region_subtag', RangeError);
        }
        var languageId = intlGetcanonicallocales.parseUnicodeLanguageId(tag);
        if (language !== undefined) {
        ...
        return Intl.getCanonicalLocales(intlGetcanonicallocales.emitUnicodeLocaleId(__assign(__assign({}, intlGetcanonicallocales.parseUnicodeLocaleId(tag)), { lang: languageId })))[0];
    }
    function applyUnicodeExtensionToTag(tag, options, relevantExtensionKeys) {
        var unicodeExtension;
        var keywords = [];
        var ast = intlGetcanonicallocales.parseUnicodeLocaleId(tag);
        ...
        result.locale = Intl
            .getCanonicalLocales(intlGetcanonicallocales.emitUnicodeLocaleId(ast))[0];
        return result;
    }
    function mergeUnicodeLanguageId(lang, script, region, variants, replacement) {
        ...
        return {
            ...
            variants: __spreadArrays(variants, replacement.variants),
        };
    }
    function addLikelySubtags(tag) {
        ...
        if (script && region) {
            var match_1 = likelySubtags[intlGetcanonicallocales.emitUnicodeLanguageId({ lang: lang, script: script, region: region, variants: [] })];
            if (match_1) {
                var parts_1 = intlGetcanonicallocales.parseUnicodeLanguageId(match_1);
                ast.lang = mergeUnicodeLanguageId(undefined, undefined, undefined, variants, parts_1);
                return intlGetcanonicallocales.emitUnicodeLocaleId(ast);
            }
        }
        if (script) {
            var match_2 = likelySubtags[intlGetcanonicallocales.emitUnicodeLanguageId({ lang: lang, script: script, variants: [] })];
            if (match_2) {
                var parts_2 = intlGetcanonicallocales.parseUnicodeLanguageId(match_2);
                ast.lang = mergeUnicodeLanguageId(undefined, undefined, region, variants, parts_2);
                return intlGetcanonicallocales.emitUnicodeLocaleId(ast);
            }
        }
        if (region) {
            var match_3 = likelySubtags[intlGetcanonicallocales.emitUnicodeLanguageId({ lang: lang, region: region, variants: [] })];
            if (match_3) {
                var parts_3 = intlGetcanonicallocales.parseUnicodeLanguageId(match_3);
                ast.lang = mergeUnicodeLanguageId(undefined, script, undefined, variants, parts_3);
                return intlGetcanonicallocales.emitUnicodeLocaleId(ast);
            }
        }
        var match = likelySubtags[lang] ||
            likelySubtags[intlGetcanonicallocales.emitUnicodeLanguageId({ lang: 'und', script: script, variants: [] })];
        if (!match) {
            throw new Error("No match for addLikelySubtags");
        }
        var parts = intlGetcanonicallocales.parseUnicodeLanguageId(match);
    ...
    function removeLikelySubtags(tag) {
        ...
        maxLocale = intlGetcanonicallocales.emitUnicodeLanguageId(__assign(__assign({}, intlGetcanonicallocales.parseUnicodeLanguageId(maxLocale)), { variants: [] }));
        var ast = intlGetcanonicallocales.parseUnicodeLocaleId(tag);
        var _a = ast.lang, lang = _a.lang, script = _a.script, region = _a.region, variants = _a.variants;
        var trial = addLikelySubtags(intlGetcanonicallocales.emitUnicodeLanguageId({ lang: lang, variants: [] }));
        if (trial === maxLocale) {
            return intlGetcanonicallocales.emitUnicodeLocaleId(__assign(__assign({}, ast), { lang: mergeUnicodeLanguageId(lang, undefined, undefined, variants) }));
        }
        if (region) {
            var trial_1 = addLikelySubtags(intlGetcanonicallocales.emitUnicodeLanguageId({ lang: lang, region: region, variants: [] }));
            if (trial_1 === maxLocale) {
                return intlGetcanonicallocales.emitUnicodeLocaleId(__assign(__assign({}, ast), { lang: mergeUnicodeLanguageId(lang, undefined, region, variants) }));
            }
        }
        if (script) {
            var trial_2 = addLikelySubtags(intlGetcanonicallocales.emitUnicodeLanguageId({ lang: lang, script: script, variants: [] }));
            if (trial_2 === maxLocale) {
                return intlGetcanonicallocales.emitUnicodeLocaleId(__assign(__assign({}, ast), { lang: mergeUnicodeLanguageId(lang, script, undefined, variants) }));
            }
        }
        return tag;
    }
    var Locale = /** @class */ (function () {
        ...
        Object.defineProperty(Locale.prototype, "baseName", {
            get: function () {
                var locale = getInternalSlots(this).locale;
                return intlGetcanonicallocales.emitUnicodeLanguageId(intlGetcanonicallocales.parseUnicodeLanguageId(locale));
            },
            enumerable: false,
            configurable: true
        });
        ...
        Object.defineProperty(Locale.prototype, "language", {
            ...
            get: function () {
                var locale = getInternalSlots(this).locale;
                return intlGetcanonicallocales.parseUnicodeLanguageId(locale).lang;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(Locale.prototype, "script", {
            ...
            get: function () {
                var locale = getInternalSlots(this).locale;
                return intlGetcanonicallocales.parseUnicodeLanguageId(locale).script;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(Locale.prototype, "region", {
            ...
            get: function () {
                var locale = getInternalSlots(this).locale;
                return intlGetcanonicallocales.parseUnicodeLanguageId(locale).region;
            },
            enumerable: false,
            configurable: true
        });
    ...
    function shouldPolyfill() {
        return (typeof Intl === 'undefined' ||
            ...
            new Intl.Locale('und-x-private').toString() === 'x-private');
    }
